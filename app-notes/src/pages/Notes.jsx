...
const Notes = () => {
    ...
    return (
        ...
        <div className="max-w-6xl mx-auto p-4">
            ...
            {/* PANEL PRINCIPAL (fondo + sombra solo para /notes) */}
            <div className="rounded-2xl bg-white/5 backdrop-blur-md border border-white/10 shadow-2xl shadow-black/30 p-6">
